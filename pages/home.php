    ...
    <body class="royal_preloader">
        ...
        <section class="team-area-v3 team-area-v4 bg_cover pb-100">
            <div class="custom-container">
                <div class="team-wrapper bg_cover" style="background-image: url(assets/images/bg/team-bg.png);">
                        ...
                        while ($voResultadoDiferenciais = mysqli_fetch_object($vrsExecutaDiferenciais)) {
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="team-item text-center mb-55">
                                    <div class="team-img">
                                        <img src="<?php echo URL . "wdadmin/uploads/informacoes/" . $voResultadoDiferenciais->imagem ?>" alt="">
                                    </div>
